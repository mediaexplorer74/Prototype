//Prototype, a port/conversion of the retro-game Prototype.
...
void find_exe_dir()
{
    ...
    */
	...
	// must return "C:\Data\Users\DefApps\APPDATA\Local\Packages\Prototype_........\LocalState"
	wcstombs
...
const char* locate_file_(const char* filename, char* path_buffer, int buffer_size)
{
	...
	else
	{
		/*
		// old functionality
		// If failed, it may be that Prototype is being run from the wrong different working directory.
...
*/
			...
			case SDL_WINDOWEVENT_FOCUS_GAINED:
				// Fix for this bug: When playing back a recording, Alt+Tabbing back to Prototype stops the replay if Alt is released before Tab.
			{ // If Alt is held down from Alt+Tab: ignore it until it's released.
